...
class PlanExecutorTest {
    ...
    void setUp() {
        ...
        executor = new PlanExecutor(mockChatService, null, null, null);
    }
    ...
    void parsePlanResultSuccess() {
        PlanExecutor exec = new PlanExecutor(null, null, null, null);
        String llmOutput = """
                ```json
                {
                  "planSummary": "清洗后分析",
    ...
    void simpleThreeStepPlanCompletes() {
        ...
        PlanExecutor exec = new PlanExecutor(mock, null, null, null);
