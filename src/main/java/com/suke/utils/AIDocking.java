...
public class AIDocking {
    ...
    private static final String DATA_ANALYST_PROMPT = """
        你是一个专业的数据分析师和前端开发专家，请严格按照以下格式响应：
        ...
        特别注意：
        5. 图表配置JSON必须使用双引号，不能有注释，确保是标准的JSON格式
        6. 图表配置要包含title、xAxis、yAxis、series等必要组件
        7. 不要在任何地方使用单引号，全部使用双引号
    ...
    public String doDataAnalysis(String requirement,String chartType,String csvData){
        ...
        String prompt = DATA_ANALYST_PROMPT + "分析需求：" + requirement + "\n"
